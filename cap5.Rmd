...
library(dygraphs)
bhvs <- read.csv("tabs/BeehivesMX2.csv", encoding = "UTF")
...
bx <- read.csv("tabs/ent_ton_miel_03_19.csv", encoding = "UTF")
bx2 <- bx[1:32,-1]
...
library(DT)
tab5_2 <- read.csv("tabs/ent_ton_miel_03_19_2.csv", encoding = "UTF")
...
p3 <- plot_ly(criad_reinas1, x = ~criad_reinas2[,5], y = ~criad_reinas2[,2], type = 'bar',
  ...
  layout(title = ("Gráfica 5.6. Criadores de Abeja Reina y Núcleos, por Entidad Federativa (2017)"),
         xaxis = list(title = "", tickangle =-45),
...
p4 <- plot_ly(abejas_reina2, x = ~abejas_reina2[,6], y = ~abejas_reina2[,2], type = 'bar',
  ...
  layout(title = ("Gráfica 5.7. Abejas Reina, Núcleos y Colmenas para Polinización por Entidad Federativa (2017)"),
         xaxis = list(title = "", tickangle =-45),
...
grafica3 <- plot_ly(datos3, x = ~xestados_t, y = ~ypeso_cera_t, type = 'bar',
  ...
  layout(title = ("Gráfica 5.8. Producción de Cera por Entidad Federativa, 2017 (ton)"),
         xaxis = list(title = "", tickangle = -45),  
         size = 16,
...
p5 <- plot_ly(miel_org2, x = ~miel_org2$x, y = ~miel_org2[,13], type = 'bar',
  ...
  layout(title = ("Gráfica 5.9. Producción de Miel Orgánica por Entidad Federativa, 2017 (Ton)"),
         xaxis = list(title = "", tickangle =-45),
...
p6 <- plot_ly(derivados2, x = ~derivados2[,5], y = ~derivados2[,2], type = 'bar',
  ...
  add_trace(y = ~derivados2[,4], name = 'Propóleos', 
            marker = list(color = 'red')) %>% 
  layout(title = ("Gráfica 5.10. Producción de Derivados Apícolas por Entidad Federativa, 2017"),
         xaxis = list(title = "", tickangle =-45),
         yaxis = list(title = "kg"),
         margin = list(b = 100),
         barmode = 'group')
...
p7 <- plot_ly(terr2, x = ~terr2[,5], y = ~terr2[,2], type = 'bar',
  ...
  add_trace(y = ~terr2[,4], name = 'Terrenos Privados', 
            marker = list(color = 'red')) %>% 
  layout(title = ("Gráfica 5.11. Terrenos Dedicados a Actividades Apícolas, por Entidad Federativa (2017)"),
         xaxis = list(title = "", tickangle =-45),
...
p8 <- plot_ly(hect2, x = ~hect2[,5], y = ~hect2[,2], type = 'bar',
  ...
  add_trace(y = ~hect2[,4], name = 'Terrenos Privados', 
            marker = list(color = 'red')) %>% 
  layout(title = ('Gráfica 5.12. Superficie Dedicada a Actividades Apícolas, por Entidad Federativa, 2017'),
         xaxis = list(title = "", tickangle =-45),
...
<p align="center"> **Cuadro 5.4. Valor de Exportaciones Mensuales de Miel, 1993-2018** [`r icon::fa("download")`](tabs/3_16_1_exportamiel.csv) </p>
...
<p align="center"> **Gráfica 5.13. Exportaciones Mensuales de Miel, 1993-2018** [`r icon::fa("download")`](tabs/3_16_1_exportamiel.csv) </p>
...
pexp <- plot_ly(dest3, x = ~years, y = ~ALEM, name = 'Alemania', type = 'scatter', mode = 'lines',
  ...
  layout(title = "Gráfica 5.14. Valor de las exportaciones a los principales países de destino, 2002-2019*",
         xaxis = list(title = "Año"),
...
<p align="center"> **Cuadro 5.5. Volumen de Exportaciones Mensuales de Miel (Toneladas), 2002-2019** [`r icon::fa("download")`](tabs/export_ton.csv) </p>
<br/>

```{r tab00030, echo=FALSE, fig.align='left', warning=FALSE}
library(DT)
tab0030 <- read.csv("tabs/export_ton.csv", encoding = "UTF")
...
immiel <- read.csv("tabs/import_2004_2019.csv", encoding = "UTF")

importac <- plot_ly(immiel, x = ~anio, y = ~(dolares), type = 'scatter', 
              mode = 'lines', line = list(color = 'darkblue', 
                                          width = 4))  %>%
  layout(title = "Gráfica 5.15. Importaciones Anuales de Miel, 2004-2019",
         xaxis = list(title = "Año"),
