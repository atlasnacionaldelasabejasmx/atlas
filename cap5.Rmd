...
<p align="center"> **Cuadro 5.1. Colmenas en México, 1961-2017.** [`r icon::fa("download")`](tabs/BeehivesMX.csv) </p>

```{r tab01 , echo=FALSE,warning=FALSE }
library(DT)
bhvs <- read.csv("tabs/BeehivesMX.csv", encoding = "latin1")
...
<p align="center"> **Gráfica 5.1. Colmenas en México, 1961-2017 (millones)** [`r icon::fa("download")`](tabs/BeehivesMX.csv) </p>
...
library(dygraphs)
bhvs <- read.csv("tabs/BeehivesMX2.csv", encoding = "latin1")
...
bx <- read.csv("tabs/ent_ton_miel_03_19.csv", encoding = "latin1")
bx2 <- bx[1:32,-1]
...
<br/>
*(Dar doble clic en la entidad federativa de interés para visualizarla de forma aislada).*  [`r icon::fa("download")`](tabs/ent_ton_miel_03_19.csv)
...
<p align="center"> **Cuadro 5.2. Producción de Miel por Entidad Federativa, 2003-2019 (Toneladas)** [`r icon::fa("download")`](tabs/export_ton.csv) </p>
<br/>

```{r tab5_2, echo=FALSE, fig.align='left', warning=FALSE}
library(DT)
tab5_2 <- read.csv("tabs/ent_ton_miel_03_19_2.csv", encoding = "latin1")
...
<br/>
<p align="center"> **Cuadro 5.3. Producción de Miel por municipio, 2018** [`r icon::fa("download")`](tabs/Prodmiel2018muni.csv) </p>
<br/>

```{r tabmun18, echo=FALSE }

tabmun_18 <- read.csv("tabs/Prodmiel2018muni.csv", encoding = "latin1")
...
asoc_ent_2 <- read.csv("tabs/estadisticas.csv", encoding="latin1")
...
estadisticas_t1 <- read.csv("tabs/estadisticas.csv", encoding="latin1")
...
estadisticas_t2 <- read.csv("tabs/estadisticas.csv", encoding="latin1")
...
<p align="center"> **Cuadro 5.4. Criaderos certificados de abejas reina por entidad federativa, 2017-2019** [`r icon::fa("download")`](tabs/Criadores_Tabla_a1.csv) </p>

<br/>

```{r tab5_6_1, echo=FALSE }

tab5_6_1 <- read.csv("tabs/Criadores_Tabla_a1.csv", encoding="latin1")
...
<p align="center"> **Cuadro 5.5. Criaderos certificados de abejas reina progenitoras por entidad federativa, 2017-2019** [`r icon::fa("download")`](tabs/Criadores_Tabla_a2.csv) </p>

<br/>

```{r tab5_6_2, echo=FALSE }

tab5_6_2 <- read.csv("tabs/Criadores_Tabla_a2.csv", encoding="latin1")
...
<p align="center"> **Cuadro 5.6. Criaderos certificados de núcleos de abejas por entidad federativa, 2017-2019** [`r icon::fa("download")`](tabs/Criadores_Tabla_a3.csv) </p>

<br/>

```{r tab5_6_3, echo=FALSE }

tab5_6_3 <- read.csv("tabs/Criadores_Tabla_a3.csv", encoding="latin1")
...
<p align="center"> *Fuente: SADER.* [`r icon::fa("download")`](tabs/Criadores_TablaGral.csv) </p>
...
miel_org <- read.csv("tabs/estadisticas.csv", encoding="latin1")
...
derivados <- read.csv("tabs/estadisticas.csv", encoding="latin1")
...
terr <- read.csv("tabs/superficie_apicola.csv", encoding = "latin1")
...
hect <- read.csv("tabs/superficie_apicola.csv", encoding = "latin1")
...
<p align="center"> **Cuadro 5.7. Valor de Exportaciones Mensuales de Miel, 1993-2018** [`r icon::fa("download")`](tabs/3_16_1_exportamiel.csv) </p>

<br/>

```{r tab3_16_1, echo=FALSE }

tab3_16 <- read.csv("tabs/3_16_1_exportamiel.csv", encoding = "latin1")
...
<p align="center"> **Gráfica 5.11. Exportaciones Mensuales de Miel, 1993-2018** [`r icon::fa("download")`](tabs/3_16_1_exportamiel.csv) </p>
...
exmiel <- read.csv("tabs/3_16_1_exportamiel.csv", encoding = "latin1")
...
dest <- read.csv("tabs/destinos.csv", encoding = "latin1")
...
<p align="center"> **Descargar datos** [`r icon::fa("download")`](tabs/import_export.xlsx) </p>
...
<p align="center"> **Cuadro 5.8. Volumen de Exportaciones Mensuales de Miel (Toneladas), 2002-2019** [`r icon::fa("download")`](tabs/export_ton.csv) </p>
<br/>

```{r tab00030, echo=FALSE, fig.align='left', warning=FALSE}
library(DT)
tab0030 <- read.csv("tabs/export_ton.csv", encoding = "latin1")
...
immiel <- read.csv("tabs/import_2004_2019.csv", encoding = "latin1")
