...
<p align="center"> **Gráfica 5.1 Colmenas en México, 1961-2017** [`r icon::fa("download")`](tabs/BeehivesMX.csv) </p>
...
p1 <- plot_ly(bx3, x = ~years, y = ~AGS, name = 'Aguascalientes', type = 'scatter', mode = 'lines',
  ...
  layout(title = "Gráfica 5.2. Producción de Miel por Entidad Federativa, 2003-2019",
...
<p align="center"> **Cuadro 5.2 Producción de Miel por municipio, 2018** [`r icon::fa("download")`](tabs/Prodmiel2018muni.csv) </p>
...
grafica1 <- plot_ly(datos1, x = ~xestados_t1, y = ~yacopiador_t1, type = 'bar', marker = list(color = 'deepskyblue2'),
  ...
  layout(title = ("Grafica 5.4 Unidades Económicas Acopiadoras de Miel por Entidad Federativa, 2017"),
...
<p align="center"> **Cuadro 5.3 Exportaciones Mensuales de Miel, 1993-2018** [`r icon::fa("download")`](tabs/3_16_1_exportamiel.csv) </p>
...
pexp <- plot_ly(dest3, x = ~years, y = ~ALEM, name = 'Alemania', type = 'scatter', mode = 'lines',
  ...
  layout(title = "Gráfica 5.14 Valor de las exportaciones a los principales países de destino, 2002-2018",
         xaxis = list(title = "Año"),
...
[INEGI. (2018) *Estadísticas de Comercio Exterior*.](https://www.inegi.org.mx/datos/?t=0030000000000000){target="_blank"}
...
importac <- plot_ly(immiel, x = ~anio, y = ~dolares, type = 'scatter', 
              mode = 'lines', line = list(color = 'darkblue', 
                                          width = 4))  %>%
  layout(title = "Gráfica 5.15 Importaciones Anuales de Miel, 2004-2018",
         xaxis = list(title = "Año"),
