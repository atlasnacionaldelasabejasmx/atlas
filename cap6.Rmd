...
prod_miel <- readOGR("geodata", "ent_a", verbose=FALSE, encoding = "latin1")
...
<p align="center"> **Mapa 6.1. Producción de miel por Entidad Federativa, 2019.** [`r icon::fa("download")`](tabs/prodmiel2019.csv) </p>
...
mapa_base <- readOGR("geodata", "ent_a", verbose=FALSE, encoding = "latin1")
...
mapa_base2 <- readOGR("geodata", "ent_a", verbose=FALSE, encoding = "latin1")
...
puntos <- read.csv("denue2020/INEGI_DENUE_27042020_2.csv", header = T, encoding = "latin1")
...
writeOGR(puntos_sp, "shape_files", "puntos", driver="ESRI Shapefile", encoding = 'latin1',
         overwrite_layer=T)
puntos_sp2 <- readOGR("shape_files/puntos.shp", encoding = 'latin1',
...
<p align="center"> **Mapa 6.4. Unidades Económicas de Venta de Miel, Fabricación de Insumos y Otros Servicios Relacionados con la Apicultura en México, DENUE 2020.** [`r icon::fa("download")`](denue2020/INEGI_DENUE_27042020_2.csv) </p>
