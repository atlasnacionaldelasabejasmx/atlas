...
library(kableExtra)
tab2_10_1 <- read.csv("tabs/asociaciones_api2.csv", header = F, encoding = "latin1")
...
library(kableExtra)
tabtab0x11 <- read.csv("tabs/poliniza_colm.csv", encoding = "latin1")
...
library(kableExtra)
tab0004 <- read.csv("tabs/cua_enferm_1s.csv", encoding = "latin1")
...
tab0005 <- read.csv("tabs/cua_enferm_2s.csv", encoding = "latin1")
...
tab0006 <- read.csv("tabs/cua_plaga_4s.csv", encoding = "latin1")
...
tab0007 <- read.csv("tabs/cua_otras_6s.csv", encoding = "latin1")
